...
# 크롬 드라이버 경로
CHROME_DRIVER_PATH = (
    "C:\XR_Remote v2.7_private\chromedriver.exe")
...
try: 
    # 웹 페이지 주소
    domain_url = 'https://virnect.hanmaceng.co.kr:8883/?continue=https%3A%2F%2Fvirnect.hanmaceng.co.kr%3A8886'
    ...
    # 도메인 주소로 이동 했을 경우 화면
    try:
        Login_home = driver.find_element(By.XPATH, "//div[@class='row-bg el-row is-justify-center is-align-middle el-row--flex']/div[@class='el-col el-col-24']/h2[@class='title' and contains(text(), '로그인')]")
        if Login_home.is_displayed():
            print("한맥 도메인 로그인 화면이 존재합니다.")
        else:
            print("한맥 도메인 로그인 화면이 존재하지 않습니다.")
    except NoSuchElementException:
        print("한맥 도메인 화면을 찾을 수 없습니다.")
    ...
    try:
        ...
        if display_camera_menu.is_displayed():
            ...
            print("카메라 메뉴가 존재하지 않습니다.")
    except NoSuchElementException:
        print("카메라 메뉴를 찾을 수 없습니다.")
    ...
    camera_btn = WebDriverWait(driver, 5).until(
        ...
        "//div[@class='setting-section__body horizon']/figure[@class='setting__figure']/p[@class='setting__label' and contains(text(), '카메라')]/following-sibling::span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label']")))
    actions = ActionChains(driver)\
        .move_to_element(camera_btn)\
        .click(camera_btn)\
        .perform()
    print("카메라 메뉴를 클릭했습니다.")
    
    # 10초동안 타임 슬립 : 노트북 카메라가 실행되어야 해서 카메라 옵션 박스 엘리먼트가 생각보다 늦게 올라옴, 하여 5초 타임 슬립 진행
    time.sleep(10)
    ...
    try:
        ...
        if camera_option_box.value_of_css_property('display') != 'none':
            print("카메라 옵션 박스 메뉴가 존재합니다.")
        else:
            print("카메라 옵션 박스 메뉴가 존재하지 않습니다.")
    except NoSuchElementException:
        print("카메라 옵션 박스 메뉴를 찾을 수 없습니다.")
        
    # 3초 타임 슬립
    time.sleep(3)
    
    # 카메라 선택 클릭 후 > 다시 카메라 선택 클릭
    camera_options = [
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option']",
            "message": "카메라를 선택했습니다.",
            "timeout": 5
            },
        ...
        
        {
            ...
            "message": "카메라 선택 버튼을 클릭했습니다.",
            "timeout": 5
            }
        ]
    for camere_xpath in camera_options:
        camera_input = WebDriverWait(driver, camere_xpath["timeout"]).until(
            EC.presence_of_element_located((By.XPATH, camere_xpath["xpath"])))
        actions = ActionChains(driver)\
            .move_to_element(camera_input)\
            .click(camera_input)\
            .perform()
        print(camere_xpath["message"])
        time.sleep(3)
    ...
    try:
        ...
        if input_resolution_menu.is_displayed():
            print("입력 해상도 메뉴가 존재합니다.")
        else:
            print("입력 해상도 메뉴가 존재하지 않습니다.")
    except NoSuchElementException:
        print("입력 해상도 메뉴를 찾을 수 없습니다.")
    ...
    # 입력 해상도 버튼 클릭
    xpath_options = [
        ("//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/p[@class='setting__label' and contains(text(), '입력 해상도')]/following-sibling::span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label']", "입력 해상도 버튼을 클릭했습니다."),

        # ("//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/p[@class='setting__label' and contains(text(), '입력 해상도')]/following-sibling::span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label active']", "입력 해상도 버튼을 다시 클릭했습니다."),
    ]
    for xpath, message in xpath_options:
        resolution_box = WebDriverWait(driver, 5).until(
    ...
    # 5초동안 타임 슬립 : 입력 해상도 옵션 박스 엘리먼트 출력 시간이 필요함
    time.sleep(5)
    ...
    for resolution, message in input_resolutions:
        ...
        # 입력 해상도 선택 버튼 클릭하여 입력 해상도 옵션 박스 닫기
        input_resolution_btn = WebDriverWait(driver, 5).until(
            EC.presence_of_element_located((
                By.XPATH, "//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label']")))
        actions = ActionChains(driver)\
    ...
    # 마지막 입력 해상도 버튼 클릭하여 옵션 박스 최종적으로 닫기
    resolution_close = WebDriverWait(driver, 5).until(
        EC.presence_of_element_located((
            By.XPATH, "//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label active']")))
    actions = ActionChains(driver)\
        .move_to_element(resolution_close)\
        .click(resolution_close)\
        .perform()
    print("입력 해상도 옵션 박스를 닫았습니다.")
    time.sleep(3)
    ...
    # 입출력 장치 > 입력 장치 버튼 클릭
    input_device = WebDriverWait(driver, 5).until(
        EC.presence_of_element_located((By.XPATH, "//div[@class='setting-section__body horizon']/figure[1][@class='setting__figure']/span[1][@class='popover--wrapper setting__r-selecter']/button[@class='select-label']")))
    actions = ActionChains(driver)\
        .move_to_element(input_device)\
        .click(input_device)\
        .perform()
    print("입력 장치 메뉴를 클릭했습니다.")
    ...
    for input_device_xpath in input_device_options:
        input_device = WebDriverWait(driver, input_device_xpath["timeout"]).until(
    ...
    output_device_btn = WebDriverWait(driver, 5).until(
        EC.presence_of_element_located((By.XPATH, "//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/span[1][@class='popover--wrapper setting__r-selecter']/button[@class='select-label']")))
    actions = ActionChains(driver)\
        .move_to_element(output_device_btn)\
        .click(output_device_btn)\
        .perform()
    print("출력 장치 버튼을 클릭했습니다.")
    ...
    for output_device_xpath in output_device_options:
        output_device = WebDriverWait(driver, output_device_xpath["timeout"]).until(
            EC.presence_of_element_located((By.XPATH, output_device_xpath["xpath"])))
        actions = ActionChains(driver)\
            .move_to_element(output_device)\
            .click(output_device)\
            .perform()
    ...
    # 마이크 테스트 버튼 클릭 : 마이크 테스트 버튼 다시 클릭
    mic_option_2 = [
        {
            "xpath": "//div[@class='setting-view__body']/section[2][@class='setting-section']/div[@class='setting-section__body horizon']/div[1][@class='mic-item']/button[@class='btn' and contains(text(), '마이크 테스트')]",
    ...
    recording_option = [
        {
            "xpath" : "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option' and contains(text(), '1 분')]", 
            "message" : "로컬 녹화 : 최대 녹화 시간 : 1분을 선택했습니다.",
            "timeout" : 5
            },
        ...
        {
            "xpath" : "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '5 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 5분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {   "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '10 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 10분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[4][@class='select-option' and contains(text(), '15 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 15분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {   "xpath" :"//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[5][@class='select-option' and contains(text(), '30 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 30분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {   "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[6][@class='select-option' and contains(text(), '45 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 45분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {   "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[7][@class='select-option' and contains(text(), '60 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 60분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[8][@class='select-option' and contains(text(), '90 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 90분을 선택했습니다.",
            "timeout" : 5
            },
        ...
        {
            "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[9][@class='select-option' and contains(text(), '120 분')]",
            "message": "로컬 녹화 : 최대 녹화 시간 : 120분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//div[@role='tooltip' and @class='popover select-options reverse']/div[@class='popover--body']/div[@class='select-optionbox']/button[7][@class='select-option' and contains(text(), '60 분')]",
            "message": "로컬 녹화 : Default 최대 녹화 시간 : 60분으로 다시 선택했습니다.",
            "timeout": 5
        }
        ]
    for recording_xpath in recording_option:
        recording_time = WebDriverWait(driver, recording_xpath["timeout"]).until(
            EC.presence_of_element_located((By.XPATH, recording_xpath["xpath"])))
        actions = ActionChains(driver)\
            .move_to_element(recording_time)\
            .click(recording_time)\
            .perform()
        recording_message = recording_xpath["message"]
    ...
    recording_duration = WebDriverWait(driver, 5).until(
    ...
    actions = ActionChains(driver)\
        .move_to_element(recording_duration)\
        .click(recording_duration)\
        .perform()
    ...
    recording_duration_option = [
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option active' and contains(text(), '1 분')]",
            "message": "로컬 녹화 : 녹화 간격 1분을 선택했습니다.",
            "timeout" : 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '5 분')]",
            "message": "로컬 녹화 : 녹화 간격 5분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '10 분')]",
            "message": "로컬 녹화 : 녹화 간격 10분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[4][@class='select-option' and contains(text(), '20 분')]",
            "message": "로컬 녹화 : 녹화 간격 20분을 선택했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option' and contains(text(), '1 분')]",
            "message": "로컬 녹화 : 녹화 간격 1분을 선택했습니다.",
            "timeout": 5
            }
        ]
    for recording_xpath in recording_duration_option:
        recording_duration_btn = WebDriverWait(driver, recording_xpath["timeout"]).until(
            EC.presence_of_element_located((By.XPATH, recording_xpath["xpath"])))
        actions = ActionChains(driver)\
            .move_to_element(recording_duration_btn)\
            .click(recording_duration_btn)\
            .perform()
        print(recording_xpath["message"])
        time.sleep(3)
    ...
    video_resolution_option = [
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option' and contains(text(), '360p')]",
            "message": "로컬 녹화 : 녹화 영상 해상도 360p를 클릭했습니다.",
            "timeout" : 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '480p')]",
            "message": "로컬 녹화 : 녹화 영상 해상도 480p를 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '720p')]",
            "message": "로컬 녹화 : 녹화 영상 해상도 720p를 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '480p')]",
            "message": "로컬 녹화 : 녹화 영상 해상도 Default 480p를 클릭했습니다.",
            "timeout": 5
            }
        ]
    for resolution_xpath in video_resolution_option:
        recording_resolution_btn = WebDriverWait(driver, resolution_xpath["timeout"]).until(
            EC.presence_of_element_located((By.XPATH, resolution_xpath["xpath"])))
        actions = ActionChains(driver)\
            .move_to_element(recording_resolution_btn)\
            .click(recording_resolution_btn)\
            .perform()
        print(resolution_xpath["message"])
        time.sleep(3)
    ...
    # 5초 타임 슬립 : 최대 녹화 시간 옵션 박스 엘리먼트 요소 출력이 생각보다 빠르지 않음
    time.sleep(5)
    ...
    # 3초 타임 슬립 : 최대 녹화 시간 엘리먼트 요소 출력이 생각보다 빠르지 않음
    time.sleep(3)
    
    # 환경 설정 > 서버 설정 > 최대 녹화 시간 클릭 : 5분 > 15분 > 30분 > 60분
    maximum_recording_option = [
        {
            "xpath" : "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option' and contains(text(), '5 분')]",
            "message": "서버 녹화 : 최대 시간 5분을 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '15 분')]",
            "message": "서버 녹화 : 최대 시간 15분을 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '30 분')]",
            "message": "서버 녹화 : 최대 시간 30분을 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[4][@class='select-option' and contains(text(), '60 분')]",
            "message": "서버 녹화 : 최대 시간 60분을 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '30 분')]",
            "message": "서버 녹화 : Default 최대 시간 30분을 클릭했습니다.",
            "timeout": 5
            }
    ]
    for maximum_recording_xpath in maximum_recording_option:
    ...
    # 환경 설정 > 녹화 설정 > 서버 녹화 설정 > 녹화 영상 해상도 메뉴 존재 확인
    try:
        setting_recording_server = driver.find_element(By.XPATH, 
            "//div[@class='setting-section__title' and contains(text(), '서버 녹화 설정')]/following-sibling::div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/div[@class='setting__figure--wrapper']/following-sibling::span[@class='popover--wrapper setting__r-selecter']")
        if setting_recording_server.is_displayed():
    ...
    video_resolution_option = [
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[1][@class='select-option' and contains(text(), '480p')]",
            "message": "서버 녹화 : 녹화 영상 해상도 480p를 클릭했습니다.",
            "timeout" : 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '720p')]",
            "message": "서버 녹화 : 녹화 영상 해상도 720p를 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[3][@class='select-option' and contains(text(), '1080p')]",
            "message": "서버 녹화 : 녹화 영상 해상도 1080p를 클릭했습니다.",
            "timeout": 5
            },
        ...
        {
            "xpath": "//section[@class='remote-layout']/div[@role='tooltip']/div[@class='popover--body']/div[@class='select-optionbox']/button[2][@class='select-option' and contains(text(), '720p')]",
            "message": "서버 녹화 : Default 녹화 영상 해상도 720p를 클릭했습니다.",
            "timeout": 5
            }
        ]
    for video_resolution_xpath in video_resolution_option:
        redording_resolution_btn = WebDriverWait(driver, video_resolution_xpath["timeout"]).until(
    ...
    language_select_box = WebDriverWait(driver, 5).until(
        EC.presence_of_element_located((By.XPATH, "//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label']")))
    actions = ActionChains(driver)\
    ...
    for language, language_message in translation_language:
        language_select_btn = WebDriverWait(driver, 5).until(
            EC.presence_of_element_located((
                By.XPATH, f"//section[@class='remote-layout']/div[@role='tooltip' and @class='popover select-options scroll']/div[@class='popover--body']/div[@class='ps']/div[@class='select-optionbox']/button[@class='select-option' and contains(text(), '{language}')]")))
        actions = ActionChains(driver)\
    ...
    # 번역 언어 설정 메뉴 클릭하여 옵션 박스 최종적으로 닫기
    language_select_box = WebDriverWait(driver, 5).until(
            EC.presence_of_element_located((
                By.XPATH, "//div[@class='setting-section__body horizon']/figure[2][@class='setting__figure']/span[@class='popover--wrapper setting__r-selecter']/button[@class='select-label active']")))
    actions = ActionChains(driver)\
        ...
        .click(language_select_box)\
        .perform()
    print("번역 설정 : 번역 언어 설정 옵션 박스를 닫았습니다.")
    time.sleep(3)
    ...
    try:
        video_restriction_mode = driver.find_element(By.XPATH, 
            "//div[@class='setting-view__body']/div/section[@class='setting-section list feature']/div[@class='setting-section__title' and contains(text(), '영상 공유 제어')]/following-sibling::div[@class='setting-section__body horizon']/figure[@class='setting__figure']/div[@class='check']")
        if video_restriction_mode.is_displayed():
            print("영상 제한 모드 사용 메뉴가 존재합니다.")
        else:
            print("영상 제한 모드 사용 메뉴가 존재하지 않습니다.")
    except NoSuchElementException:
        print("영상 제한 모드 사용 메뉴를 찾을 수 없습니다.")
    ...
    video_limit_option = [
        {
            "xpath": "//div[@class='setting-view__body']/div/section[@class='setting-section list feature']/div[@class='setting-section__title' and contains(text(), '영상 공유 제어')]/following-sibling::div[@class='setting-section__body horizon']/figure[@class='setting__figure']/div[@class='check']/span[@class='check-toggle']",
            "message" : "기능 설정 : 영상 제한 모드 사용을 체크하였습니다.",
            "timeout" : 5
            },
        
        {
            "xpath": "//div[@class='setting-view__body']/div/section[@class='setting-section list feature']/div[@class='setting-section__title' and contains(text(), '영상 공유 제어')]/following-sibling::div[@class='setting-section__body horizon']/figure[@class='setting__figure']/div[@class='check toggle']/span[@class='check-toggle toggle']",
            "message": "기능 설정 : 영상 제한 모드 사용을 하였습니다.",
            "timeout" : 5
            },    
            
        {
            "xpath": "//div[@class='setting-view__body']/div/section[@class='setting-section list feature']/div[@class='setting-section__title' and contains(text(), '영상 공유 제어')]/following-sibling::div[@class='setting-section__body horizon']/figure[@class='setting__figure']/div[@class='check']/span[@class='check-toggle']",
            "message": "기능 설정 : 영상 제한 모드 사용을 다시 체크하였습니다.",
            "timeout": 5
            }
        ]
