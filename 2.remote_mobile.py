...
# 크롬 드라이버 경로
CHROME_DRIVER_PATH = (
    "C:\project_hanmac\chromedriver.exe")
...
try: 
    ...
    # 도메인 주소로 이동 했을 경우 화면
    try:
        Login_home = driver.find_element(By.XPATH, 
    "//div[@class='row-bg el-row is-justify-center is-align-middle el-row--flex']/div[@class='el-col el-col-24']/h2[@class='title' and contains(text(), '로그인')]")
